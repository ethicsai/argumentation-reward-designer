...
Note that it expects to import the **AJAR** library from a `.lib` module; this
corresponds to the structure in [Ethical Smart Grid].
...
```python
from .lib import JudgingAgent

judge = JudgingAgent("moral value name", afdm)
